...
def main():
    ...
    parser.add_argument('-o', '--output', default='hc', help='Set output file prefix (default: hc)')
    ...
    parser.add_argument('-c', '--coarsening-level', type=int, default=3, help='Coarsening level (default: 3)')
    ...
    coarsen_cmd = [
        ...
        '-c', str(args.coarsening_level)  # Coarsening level
    ]
